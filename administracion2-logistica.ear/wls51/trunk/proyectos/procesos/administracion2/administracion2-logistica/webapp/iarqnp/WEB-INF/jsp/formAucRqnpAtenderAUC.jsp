...
<script type="text/javascript" LANGUAGE="JavaScript" src="${pageContext.request.contextPath}/js/formAucRqnpDetalle_structureAUC.js"> </script>
<script type="text/javascript" LANGUAGE="JavaScript" src="${pageContext.request.contextPath}/js/formAucRqnpDetalleAUC.js"> </script>
...
<body class="tundra">
	...
	<center>
		<form id="frmRegistro" name="frmRegistro" action="rqnpaucmetas.htm" method="POST" dojoType="dijit.form.Form">
			<input type="hidden" id="action" name="action" value="modificarRqnpMetasAUC"/>
			<input type="hidden" id="jParametro" name="jParametro" value="formRegistroRqnpMetasAUC"/> <!-- formAucRqnpDetalleAUC -->

			<input type="hidden" id="jParametroAuc" name="jParametroAuc" value="formAucRqnpAtenderAUC"/> <!-- formAucRqnpDetalleAUC -->
			<input type="hidden" id="txtCodigoRqnp" name="txtCodigoRqnp" value="<c:out value='${mapRqnp.codigoRqnp}'/>" />
			<input type="hidden" id="txtCodigoBien" name="txtCodigoBien" value="<c:out value='${mapRqnp.jcodigo_bien}'/>" />
			...
			<input type="hidden" id="path_url" name="path_url"  value="rqnpaucmetas.htm?action=recuperarRqnpDetalleAUC"/> <!-- recuperarDetalleAUC -->
								...
								<td>
									<table width="95%" cellpadding="2" cellspacing="2">
										<tr>
											...
											promptMessage="Proponer un Canal de Atención"
											store="idCanalStore"
											  
											style="width:200px;"
											value="01"
											missingMessage="Debe de Proponer un Canal de Atención"
											invalidMessage="Debe de Proponer un Canal de Atención"	/>
											
												</td>
												<td>
													&nbsp;&nbsp;&nbsp;
													<div id="divbtnAtender" style="display: block;" >
												...
												<td>
													&nbsp;&nbsp;&nbsp;
													<div id="divbtnSiguiente" style="display: block;" >
											...
											<td class="bg" align="left">
												...
												<input id="txtDesTec3" name="txtDesTec3" 
													...
													dojoType="dijit.form.SimpleTextarea" 
													 uppercase = "true" 
													invalidMessage="Por favor ingrese la Descrición Técnica"													
													maxlength="240"
													value =""
												/>
											</td>
			...
			<!--  EMERGENTE DE RECHAZOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO----------------------------------------------------- -->
							...
							<tr>
								<td>
									<table width="100%" cellpadding="2" cellspacing="1" >
										<tr>
											<td class="T1" colspan="2">
												<div align="center">Rechazar ÍTEM SELECCIONADOS</div>
											</td>
										</tr>
									</table>
